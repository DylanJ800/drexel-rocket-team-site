...
export default function ApplyPage() {
  ...
  function onSubmit(e: React.FormEvent) {
    ...
    // Next step: wire to a real submission endpoint (Formspree / Google Sheets / Vercel function).
    setSubmitted(true);
  }
          ...
          {submitted ? (
            <div className="mt-10 rounded-3xl border border-white/10 bg-white/5 p-6">
              ...
              <p className="mt-2 text-sm text-gray-300">
                ...
                Tell me where you want submissions to go (email, Google Sheet, etc.) and I’ll set it up.
              </p>
            ...
            <form onSubmit={onSubmit} className="mt-10 grid gap-4 md:grid-cols-2">
              <input
                ...
                className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#00539B]/40 md:col-span-1"
              ...
              <select
                ...
                className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-gray-200 focus:outline-none focus:ring-2 focus:ring-[#00539B]/40 md:col-span-2"
              >
              ...
              <input
                className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-gray-200 file:mr-4 file:rounded-lg file:border-0 file:bg-[#00539B]/20 file:px-4 file:py-2 file:text-sm file:text-white hover:file:bg-[#00539B]/30 md:col-span-2"
                type="file"
                multiple
              />
              ...
              <textarea
                ...
                className="min-h-[140px] rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#00539B]/40 md:col-span-2"
