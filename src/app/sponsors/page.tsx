...
export default function SponsorsPage() {
  ...
  const partnershipBenefits = [
    {
      title: "Advancing Our Engineering",
      body: "Sponsor support gives our students the resources to take on challenging work across liquid propulsion, turbomachinery, controls, test infrastructure, and integrated launch systems.",
    },
    {
      title: "Supporting Student Engineers",
      body: "Your support gives students the opportunity to take engineering beyond the classroom—designing, building, testing, learning from setbacks, and turning ambitious ideas into real hardware.",
    },
    {
      title: "Making Our Work Possible",
      body: "Every contribution can make a direct difference, helping provide the materials, manufacturing, testing capability, software, equipment, and other resources our projects depend on.",
    },
    {
      title: "Growing With Us",
      body: "Long-term support helps DRT build capabilities that can be passed from one generation of students to the next as the team takes on increasingly ambitious projects.",
    },
  ];
        ...
        <section className="relative overflow-hidden border-b border-white/5 bg-black">
          ...
          <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-32">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-300">
              The work we do would not be possible without the organizations that choose to support student engineering. We are incredibly grateful to the sponsors who provide the resources, tools, expertise, and opportunities that allow Drexel Rocket Team to keep learning, building, and pushing toward what comes next.
            </p>

            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/sponsors/inquiry" className="rounded-2xl bg-[#00539B] px-6 py-3 text-sm font-medium text-white transition hover:bg-[#0068c4]">
                Become a Sponsor
              </Link>
              <a href="#current-partners" className="rounded-2xl border border-white/15 px-6 py-3 text-sm font-medium text-gray-200 transition hover:border-[#00539B]/60 hover:bg-[#00539B]/10">
                Meet Our Sponsors
              </a>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-6 py-20">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-gray-400">
                We are proud to recognize the organizations whose support helps make our projects possible. Their contributions give our students opportunities to learn through real engineering challenges, and we are sincerely grateful to have them behind us.
              </p>
            </div>

            <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {sponsors.map((s) => (
                <div key={s.name} className="group flex h-40 items-center justify-center rounded-3xl border border-white/10 bg-white/[0.04] p-7 transition duration-300 hover:-translate-y-1 hover:border-[#00539B]/50 hover:bg-white/[0.07] hover:shadow-[0_0_45px_rgba(0,83,155,0.14)]">
            ...
            <div className="grid gap-10 lg:grid-cols-12">
              <div className="lg:col-span-4">
                ...
                <p className="mt-5 text-gray-300">
                  Sponsorship is more than a name on our website. It gives our students the ability to design, manufacture, instrument, and test hardware that would otherwise be out of reach. We value every organization that chooses to be part of that journey with us.
                </p>
              </div>
        ...
        <section className="border-b border-white/5 bg-zinc-950">
          <div className="mx-auto max-w-7xl px-6 py-20">
            ...
            <p className="mt-4 max-w-3xl text-gray-400">
              Each program builds on the lessons and capabilities of the one before it. Sponsor support helps us continue that progression and gives students the chance to take on challenges at an increasingly advanced level.
            </p>
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-[#00539B]/30 bg-[#00539B]/10 px-7 py-12 md:px-12 md:py-16">
              ...
              <div className="relative max-w-3xl">
                ...
                <p className="mt-5 max-w-2xl text-gray-300">
                  Whether through funding, hardware, software, manufacturing, technical expertise, or another form of support, every sponsorship helps create opportunities for our students to learn by building. Thank you for considering becoming part of Drexel Rocket Team&apos;s journey.
                </p>
                <div className="mt-8 flex flex-wrap gap-3">
